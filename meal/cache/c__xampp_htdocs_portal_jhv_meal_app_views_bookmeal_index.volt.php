...
<div class="card">
    <div class="card-body">
        ...
        <p>
            <?= $this->tag->linkTo(['bookmeal/new', 'Tạo suất ăn mới', 'class' => 'btn btn-outline-primary btn-sm my-2 mx-3']) ?>
        </p>
            <?= $this->getContent() ?>

            <?= $this->tag->form(['bookmeal/search', 'method' => 'post', 'autocomplete' => 'off', 'class' => 'form-horizontal']) ?>
