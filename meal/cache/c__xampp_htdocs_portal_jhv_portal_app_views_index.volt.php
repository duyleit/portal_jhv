        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExample07">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link<?php if ($this->dispatcher->getControllerName() == 'gm') { ?> active<?php } ?>" href="<?= $this->url->get('gm') ?>"><small>Ban Tổng Giám Đốc</small><br />總經理部</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link disabled<?php if ($this->dispatcher->getControllerName() == 'ga') { ?> active<?php } ?>" href="<?= $this->url->get('ga') ?>" aria-disabled="true"><small>Hành Chánh-Tổng Vụ</small><br />行政總務</a>
                    </li>
                    <li class="nav-item">
