...
<div class="card">
    <div class="card-body">
        ...
        <p>
            {{ link_to("bookmeal/new", "Tạo suất ăn mới",'class':'btn btn-outline-primary btn-sm my-2 mx-3') }}
        </p>
            {{ content() }}

            {{ form("bookmeal/search", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}
