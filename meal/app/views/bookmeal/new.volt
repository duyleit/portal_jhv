...
<div id="content">
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                 <span class="previous">{{ link_to("bookmeal", "Tìm Kiếm 搜索",'class':'btn btn-outline-primary my-2 mx-3') }}</span>
             </div>
            <div>
            ...
            {{ form("bookmeal/create", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}
