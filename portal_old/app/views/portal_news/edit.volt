...
{{ form("portal_news/save", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}

<div class="form-group d-none">
    <label for="fieldId" class="col-sm-2 control-label">Id</label>
    <div class="col-sm-10">
        {{ text_field("if", "type" : "numeric", "class" : "form-control", "id" : "fieldId") }}
    </div>
</div>
...
<div class="form-group">
    <label for="fieldDescription" class="col-sm-2 control-label">Tiêu đề 標題</label>
    <div class="col-sm-10">
        {{ text_area("description", "cols": "30", "rows": "2", "class" : "form-control", "id" : "fieldDescription") }}
    </div>
</div>
