...
{{ partial("partial/headerBanner", ['title': 'Hành Chánh-Tổng Vụ 行政總務']) }}
...
<div id="content">
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="green underline">Aenean suscipit <small class="font-italic">(risus)</small></h5>
    ...
    <div id="int-hr" class="card">
        <div class="card-body">
            <h5 class="red underline">Vivamus risus sem</h5>
            <p class="file-download">
                <a href="#" class="btn btn-outline-secondary btn-sm"><i class="fa fa-file-pdf-o red" aria-hidden="true"></i> Vivamus risus sem.pdf</a>
                <a href="#" class="btn btn-outline-secondary btn-sm"><i class="fa fa-file-excel-o green" aria-hidden="true"></i> Aliquam erat volutpat.xls</a>
                <a href="#" class="btn btn-outline-secondary btn-sm"><i class="fa fa-file-word-o blue" aria-hidden="true"></i> Aenean suscipit.doc</a>
    ...
    <div id="ehs-hr" class="card">
        <div class="card-body">
            <h5 class="blue underline">Aliquam erat volutpat</h5>
            <p class="file-download">
                <a href="#" class="btn btn-outline-secondary btn-sm"><i class="fa fa-file-pdf-o red" aria-hidden="true"></i> Vivamus risus sem.pdf</a>
                <a href="#" class="btn btn-outline-secondary btn-sm"><i class="fa fa-file-excel-o green" aria-hidden="true"></i> Aliquam erat volutpat.xls</a>
                <a href="#" class="btn btn-outline-secondary btn-sm"><i class="fa fa-file-word-o blue" aria-hidden="true"></i> Aenean suscipit.doc</a>
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="orange underline">Vivamus risus sem</h5>
            <p class="file-download">
                <a href="#" class="btn btn-outline-secondary btn-sm"><i class="fa fa-file-pdf-o red" aria-hidden="true"></i> Vivamus risus sem.pdf</a>
                <a href="#" class="btn btn-outline-secondary btn-sm"><i class="fa fa-file-excel-o green" aria-hidden="true"></i> Aliquam erat volutpat.xls</a>
                <a href="#" class="btn btn-outline-secondary btn-sm"><i class="fa fa-file-word-o blue" aria-hidden="true"></i> Aenean suscipit.doc</a>
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="underline">Aenean suscipit</h5>
            <p class="file-download">
                <a href="#" class="btn btn-outline-secondary btn-sm"><i class="fa fa-file-pdf-o red" aria-hidden="true"></i> Vivamus risus sem.pdf</a>
                <a href="#" class="btn btn-outline-secondary btn-sm"><i class="fa fa-file-excel-o green" aria-hidden="true"></i> Aliquam erat volutpat.xls</a>
                <a href="#" class="btn btn-outline-secondary btn-sm"><i class="fa fa-file-word-o blue" aria-hidden="true"></i> Aenean suscipit.doc</a>
