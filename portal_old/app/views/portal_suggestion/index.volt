<div class="page-header">
    <h1>
        Search portal_suggestion
    </h1>
    <p>
        {{ link_to("portal_suggestion/new", "Create portal_suggestion") }}
    </p>
</div>

{{ content() }}

{{ form("portal_suggestion/search", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}
