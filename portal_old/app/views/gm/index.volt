        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md news">
                    <h5 class="green underline">Chính Sách Công Ty 公司政策{% if session.get('user') != null %} <a href="{{ url('portal_news') }}" title="Chỉnh sửa 編輯"><i class="fa fa-edit" aria-hidden="true"></i></a>{% endif %}</h5>

                    {% for policy in policies %}
                        <a href="{{ url('news/detail/'~policy.id) }}">
