        ...
        <div class="card-body">
            ...
            <form action="TestPost/create" method="post" class="form-horizontal">
                <div class="form-group">
                    ...
                    <?= $this->tag->textField(['picture', 'size' => 30, 'class' => 'form-control', 'id' => 'fieldPicture', 'readonly' => 'readonly', 'placeholder' => 'Chọn hình', 'onclick' => 'openKCFinder(this)']) ?>
                </div>

                <div class="form-group">
                    <label for="">Nội dung</label>
                    <?= $this->tag->textArea(['content', 'row' => 5, 'col' => 15, 'class' => 'form-control', 'id' => 'fieldContent']) ?>
                </div>
           <div class="row">
               <div class="col-md">
                   <div class="form-group">
                     ...
                     <div class="input-group date" >
                       <?= $this->tag->textField(['startday', 'class' => 'form-control datetimepicker-input', 'id' => 'fieldDateStart', 'size' => 30]) ?>
               ...
               <div class="col-md">
                   <div class="form-group">
                       ...
                       <?= $this->tag->textField(['endday', 'class' => 'form-control', 'id' => 'fieldEndDay', 'size' => 15]) ?>
                   </div>
               </div>
           </div>
