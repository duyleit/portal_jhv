        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="post" action="{{ url('edit/password') }}">
                    ...
                    <div class="form-group row">
                        <div class="col-sm">
                            <a class="btn btn-outline-secondary btn-block" href="{{ url('auth/logged') }}"><i class="fa fa-user" aria-hidden="true"></i> Người Dùng 用户</a>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm">
                            <a class="btn btn-outline-secondary btn-block" href="{{ url('../') }}"><i class="fa fa-home" aria-hidden="true"></i> Trang Chủ 首頁</a>
                        </div>
                    </div>
                </form>
