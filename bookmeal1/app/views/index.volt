        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExample07">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link{% if dispatcher.getControllerName()=='meal' %} active{% endif %}" href="{{ url('meal') }}"><small>Ban Tổng Giám Đốc</small><br />總經理部</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link{% if dispatcher.getControllerName()=='hr' %} active{% endif %}" href="{{ url('hr') }}"><small>Bộ Phận Nhân Sự</small><br />人力資源</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {% if dispatcher.getControllerName()=='ga' %} active{% endif %}" href="{{ url('ga') }}"><small>Hành Chánh-Tổng Vụ</small><br />行政總務</a>
                    </li>
                    <li class="nav-item">
